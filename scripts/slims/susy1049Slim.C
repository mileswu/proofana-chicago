...
void susy1049Slim(bool isMC = false){

  // Say Hello
  cout << "susy1049Slim() has been called" << endl;
  ...
  */
  ...
  for (Int_t i = 0; i < nJetTypes; i++) {
    ...
    tree->SetBranchStatus(TString(jetTypes[i] + "_emscale_m"),1);
    tree->SetBranchStatus(TString(jetTypes[i] + "_YFlip12"),1);
    tree->SetBranchStatus(TString(jetTypes[i] + "_YFlip23"),1);
    ...
    tree->SetBranchStatus(TString(jetTypes[i] + "_flavor_component_jfit_pu"),1);
    tree->SetBranchStatus(TString(jetTypes[i] + "_flavor_component_jfit_pc"),1);
    tree->SetBranchStatus(TString(jetTypes[i] + "_flavor_component_jfit_pb"),1);
    tree->SetBranchStatus(TString(jetTypes[i] + "_flavor_component_jfit_isValid"),1);
    
    tree->SetBranchStatus(TString(jetTypes[i] + "_flavor_component_jfitcomb_pu"),1);
    tree->SetBranchStatus(TString(jetTypes[i] + "_flavor_component_jfitcomb_pc"),1);
    tree->SetBranchStatus(TString(jetTypes[i] + "_flavor_component_jfitcomb_pb"),1);
    tree->SetBranchStatus(TString(jetTypes[i] + "_flavor_component_jfitcomb_isValid"),1); 
