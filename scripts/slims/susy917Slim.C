...
void susy917Slim(bool isMC = false){

  // Say Hello
  cout << "susy917Slim() has been called" << endl;
  ...
  //b-triggers
  tree->SetBranchStatus("EF_2b10*",1);
  tree->SetBranchStatus("EF_2b15*",1);
  tree->SetBranchStatus("EF_2b20*",1);
  tree->SetBranchStatus("EF_b10*",1);
